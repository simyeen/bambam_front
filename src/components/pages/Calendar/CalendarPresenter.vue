<template>
  <div class="lg:pl-72">
    ...
    <div class="bg-white">
      ...
      >
        <section v-for="month in updatedMonths" :key="month.name" class="text-center">
...
const updatedMonths = ref(null);

onMounted(async () => {
  try {
    const { data } = await StatisAPI.feedDate({
      id: 16,
      headers: {
    ...
    // 받아온 데이터 예시: ['2024-09-10', '2024-09-11', ...]
    const feedDates = data.map((date) => date.split('-').join('-'));

    // months 배열을 업데이트하여 feedDates에 포함된 날짜에 isToday 추가
    updatedMonths.value = months.map((month) => ({
      ...month,
      days: month.days.map((day) => ({
        ...day,
        isToday: feedDates.includes(day.date) ? true : day.isToday || false
      }))
    }));
...
const months = [
  ...
  },
  {
    ...
    days: [
      ...
      { date: '2022-09-10', isCurrentMonth: true, isToday: true },
      { date: '2022-09-11', isCurrentMonth: true, isToday: true },
      { date: '2022-09-12', isCurrentMonth: true, isToday: true },
      { date: '2022-09-13', isCurrentMonth: true, isToday: true },
      { date: '2022-09-14', isCurrentMonth: true },
      { date: '2022-09-15', isCurrentMonth: true },
      { date: '2022-09-16', isCurrentMonth: true, isToday: true },
      { date: '2022-09-17', isCurrentMonth: true, isToday: true },
      { date: '2022-09-18', isCurrentMonth: true, isToday: true },
      { date: '2022-09-19', isCurrentMonth: true },
      { date: '2022-09-20', isCurrentMonth: true, isToday: true },
      { date: '2022-09-21', isCurrentMonth: true, isToday: true },
      { date: '2022-09-22', isCurrentMonth: true, isToday: true },
